...
### **By Interest Area**
- **Making & Fabrication**: Start with [[projects/family-coasters|Family Coasters]] to see foundational skills in action
- **Problem Solving**: Explore [[projects/robot-storage|Robot Storage]] for professional design thinking application  
- **Collaboration**: Examine [[projects/dollhouse-design|Dollhouse Design]] for cross-curricular partnership
- **Independent Learning**: Discover [[projects/individual-explorations|Individual Explorations]] for self-directed innovation
...
- **[[concepts/design-thinking|Design Thinking]]**: See human-centered process applied across all project types
- **[[concepts/4ms-framework|Systems Thinking]]**: Understand how Maker, Machine, Method, Materials, Margin interact
- **[[concepts/ai-integration|AI Partnership]]**: Observe responsible AI integration in design and fabrication
- **[[concepts/reflection-methods|Learning Documentation]]**: Notice how reflection drives continuous improvement
...
*Navigate: [[index|ê Course Home]] | [[projects/family-coasters|Family Coasters í]] | [[concepts/|Core Concepts í]] | [[learning-journey/timeline|Learning Journey í]]*