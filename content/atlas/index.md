...
1. **Choose a shelf** – Concepts (why), Connections (so what), or Tools & Techniques (how).
2. **Follow the highlighted MOCs** – each opens a curated list of supporting notes and exemplars.
3. **Jump to projects** to see the ideas in action, then loop back for deeper study.

> [!info] Shortcut
> Already know what you need? Use the quick links below and you can always return to this hub with `⌘K` → “Atlas”.
...
- [[atlas/concepts/AI Integration|AI as Creative Partner]] paired with [[atlas/concepts/AI Integration MOC|AI Integration MOC]] – ethics-first AI collaboration.
- [[atlas/concepts/Reflection Methods|Reflection Methods]] – assess through documentation, journaling, and peer feedback.
...
- [[calendar/milestones|Milestones]] – waypoint reflections when ideas met audiences.

> [!hint]
> Use these notes to plan showcases, communicate with stakeholders, or identify new partnership opportunities.
...
- [[atlas/tools-techniques/Assessment Portfolio|Assessment Portfolio]] – evidence capture and growth documentation.

> [!example] Prep for `Robot Storage`
> - Review [[atlas/concepts/4Ms Framework MOC|4Ms MOC]] to map requirements.  
> - Study [[atlas/tools-techniques/Onshape CAD|Onshape CAD]] for precision modeling.  
> - Check [[efforts/Robot Storage|Robot Storage]] to see deliverables and teacher collaboration notes.
