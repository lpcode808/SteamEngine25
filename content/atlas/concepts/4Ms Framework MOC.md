...
2.  **[[concepts/4Ms Framework#machine|Machine]]**: The tools you use.
    ...
    -   **See it in action**: Choosing the [[tools-techniques/Laser Cutting|laser cutter]] (`Machine`) for the [[efforts/Family Coasters|Family Coasters]] project defined the possible materials and precision.
...
-   **Assessment**: When you document a challenge in your **[[tools-techniques/Assessment Portfolio|Portfolio]]**, use the 4Ms to diagnose what went wrong. For example, "My joint didn't fit. The `Method` was right, but I didn't account for the `Material` thickness and the `Machine`'s kerf."

---

> [!seealso] See Also
> - [[concepts/Design Thinking|Design Thinking]] - The 4Ms is a great tool to use within the Design Thinking process.
> - [[concepts/Constraint-Based Creativity|Constraint-Based Creativity]] - Each of the 4Ms can be a creative constraint.
