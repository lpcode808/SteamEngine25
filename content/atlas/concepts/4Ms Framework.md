...
*Based on the [Ishikawa diagram](https://en.wikipedia.org/wiki/Ishikawa_diagram) for root cause analysis, adapted for educational making.*
...
Projects like [[efforts/Robot Storage|Robot Storage]] and [[efforts/Dollhouse Design|Dollhouse]] required balancing material properties with functional requirements.

#### Material-Machine Interactions
- **[[atlas/tools-techniques/Laser Cutting|Laser Cutting]]**: 1/4" wood maximum, different settings for different materials
- **[[atlas/tools-techniques/Onshape CAD|CAD Modeling]]**: Designing for material thickness and properties
