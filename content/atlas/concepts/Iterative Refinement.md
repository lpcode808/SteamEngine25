...
### [[atlas/concepts/Design Thinking|Design Thinking]] as Iteration

The entire design thinking process is iterative:

1. **[[atlas/concepts/Design Thinking#empathize|Empathize]]** → Learn about users
2. **[[atlas/concepts/Design Thinking#define|Define]]** → Frame the problem
3. **[[atlas/concepts/Design Thinking#ideate|Ideate]]** → Generate possibilities
4. **[[atlas/concepts/Design Thinking#prototype|Prototype]]** → Make it testable
5. **[[atlas/concepts/Design Thinking#test|Test]]** → Learn what works
...
Both [[efforts/Robot Storage|Robot Storage]] and [[efforts/Dollhouse Design|Dollhouse]] projects evolved through multiple testing cycles, with each iteration revealing new insights about functionality, precision requirements, and user needs.
...
### [[atlas/concepts/Reflection Methods|Reflection Between Iterations]]
...
- [[atlas/tools-techniques/Laser Cutting|Laser cutting workflow]] refinement
- [[atlas/tools-techniques/Onshape CAD|CAD modeling]] efficiency increases
...
- [[atlas/concepts/Functional Testing|Core functions]] work reliably
