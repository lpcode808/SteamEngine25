...
- **Test early and often** with [[4ms-cardboard-prototyping|simple prototypes]]
...
### [[design-thinking|Design Thinking]] as Iteration

The entire design thinking process is iterative:

1. **[[design-thinking#empathize|Empathize]]** → Learn about users
2. **[[design-thinking#define|Define]]** → Frame the problem
3. **[[design-thinking#ideate|Ideate]]** → Generate possibilities
4. **[[design-thinking#prototype|Prototype]]** → Make it testable
5. **[[design-thinking#test|Test]]** → Learn what works
...
Both [[../projects/robot-storage|Robot Storage]] and [[../projects/dollhouse-design|Dollhouse]] projects evolved through multiple testing cycles, with each iteration revealing new insights about functionality, precision requirements, and user needs.
...
- [[../tools-techniques/laser-cutting|Laser cutting workflow]] refinement
- [[../tools-techniques/onshape-cad|CAD modeling]] efficiency increases
- File format translation streamlines

### Materials
**Material understanding grows through testing**
- [[4ms-cardboard-prototyping|Cardboard]] for early iterations
- [[4ms-plywood-projects|Plywood]] for refined prototypes
...
- [[functional-testing|Core functions]] work reliably
...
*Navigate: [[../concepts|← Concepts Home]] | [[functional-testing|Functional Testing ←]] | [[rapid-iteration|Rapid Iteration →]]*
